...
public class Board
{
    ...
    {
        #region GreyRoutes
        Routes.AddRoute(City.Montreal, City.Boston, "grey", 2, 2,"MONTREAL-BOSTON              ");  //double grey
        ...
        Routes.AddRoute(City.Raleigh, City.Washington, "grey", 2, 2,"RALEIGH-WASHINGTON        ");//double grey
        Routes.AddRoute(City.Atlanta, City.Raleigh, "grey", 2, 2,"ATLANTA-RALEIGH              ");//double grey
        ...
        Routes.AddRoute(City.KansasCity, City.OklahomaCity, "grey", 2, 2,"KANSAS-OKLAHOMA      ");//double grey
        ...
        Routes.AddRoute(City.OklahomaCity, City.Dallas, "grey", 2, 2,"OKLAHOMA-DALLAS          ");//double grey
        Routes.AddRoute(City.Dallas, City.LittleRock, "grey", 2, 1,"DALLAS-LITTLEROCK          ");
        Routes.AddRoute(City.Houston, City.Dallas, "grey", 1, 2,"HOUSTON-DALLAS                ");//double grey
        Routes.AddRoute(City.Houston, City.NewOrleans, "grey", 2, 1,"HOUSTON-NEWORLEANS        ");
        Routes.AddRoute(City.KansasCity, City.Omaha, "grey", 1, 2,"KANSAS-OMAHA                ");//double grey
        Routes.AddRoute(City.Omaha, City.Duluth, "grey", 2, 2,"OMAHA-DULUTH                    ");//double grey
        ...
        Routes.AddRoute(City.Seattle, City.Portland, "grey", 1, 2,"SEATTLE-PORTLAND            ");//double grey
        Routes.AddRoute(City.Seattle, City.Vancouver, "grey", 1, 2,"SEATTLE-VANCOUVER          ");//double grey
        ...
        Routes.AddRoute(City.KansasCity, City.SaintLouis, "blue", 2, 2,"KANSAS-SAINTLOUIS");//the other double is pink
        ...
        #region RedRoutes
        Routes.AddRoute(City.Boston, City.NewYork, "red", 2, 2,"BOSTON-NEWYORK      ");//the other double is yellow
        ...
        Routes.AddRoute(City.SaltLakeCity, City.Denver, "red", 3, 2,"SALTLAKE-DENVER");//the other double is yellow

        #endregion

        #region YellowRoutes
        Routes.AddRoute(City.Boston, City.NewYork, "yellow", 2, 2,"BOSTON-NEWYORK                  ");//the other is red
        Routes.AddRoute(City.Pittsburgh, City.Nashville, "yellow", 4, 1,"PITTSBURG-NASHVILLE       ");
        Routes.AddRoute(City.Atlanta, City.NewOrleans, "yellow", 4, 2,"ATLANTA-NEWORLEANS          ");//the other is orange
        Routes.AddRoute(City.OklahomaCity, City.ElPaso, "yellow", 5, 1,"OKLAHOMA-ELPASO            ");
        Routes.AddRoute(City.SaltLakeCity, City.Denver, "yellow", 3, 2,"SALTLAKE-DENVER            ");//the other is red
